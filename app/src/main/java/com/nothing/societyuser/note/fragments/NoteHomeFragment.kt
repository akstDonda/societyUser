...
import com.nothing.societyuser.databinding.FragmentNoteHomeBinding
import com.nothing.societyuser.note.NotesMainActivity
import com.nothing.societyuser.note.adapter.NoteAdapter
import com.nothing.societyuser.note.model.Note
import com.nothing.societyuser.note.viewmodel.NoteViewModel


class NoteHomeFragment : Fragment(R.layout.fragment_home), SearchView.OnQueryTextListener,MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addNoteFab.setOnClickListener {
            it.findNavController().navigate(R.id.action_noteHomeFragment_to_noteAddNoteFragment)
